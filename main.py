...
try:
    ...
    if invalid_attributes:
        print(f"\nError: Los siguientes atributos no existen para el personaje consultado: {', '.join(invalid_attributes)}")
    else:
    ...
    print("Error: Ingrese un ID de personaje válido como un número entero.")